...
import org.chuma.homecontroller.extensions.external.robonect.client.model.ErrorList;
import org.chuma.homecontroller.extensions.external.robonect.client.model.GpsInfo;
import org.chuma.homecontroller.extensions.external.robonect.client.model.ModelParser;
import org.chuma.homecontroller.extensions.external.robonect.client.model.MowerInfo;
import org.chuma.homecontroller.extensions.external.robonect.client.model.MowerMode;
import org.chuma.homecontroller.extensions.external.robonect.client.model.Name;
import org.chuma.homecontroller.extensions.external.robonect.client.model.RobonectAnswer;
import org.chuma.homecontroller.extensions.external.robonect.client.model.VersionInfo;
import org.chuma.homecontroller.extensions.external.robonect.client.model.WeatherInfo;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.Command;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.ErrorCommand;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.GpsCommand;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.ModeCommand;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.NameCommand;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.StartCommand;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.StatusCommand;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.StopCommand;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.VersionCommand;
import org.chuma.homecontroller.extensions.external.robonect.client.model.cmd.WeatherCommand;
 ...
 *
 * @see <a href="https://forum.robonect.de/viewtopic.php?f=10&t=37">
 *      https://forum.robonect.de/viewtopic.php?f=10&amp;t=37</a>. The API of the module is documented here.
 * @see <a href="https://forum.robonect.de/viewtopic.php?f=10&t=2535"
 *
...
public class RobonectClient {
     ...
     */
    public RobonectClient(RobonectEndpoint endpoint) {
        this.httpClient = new HttpClient();
        try {
            httpClient.start();
        } catch (Exception e) {
            throw new RobonectCommunicationException("Could not start HTTP client", e);
        }
    ...
    public GpsInfo getGpsInfo() {
        String responseString = sendCommand(new GpsCommand());
        return parser.parse(responseString, GpsInfo.class);
    }

    public WeatherInfo getWeatherInfo() {
        String responseString = sendCommand(new WeatherCommand());
        return parser.parse(responseString, WeatherInfo.class);
    }

    private String sendCommand(Command command) {
        try {
            if (logger.isTraceEnabled()) {
                logger.trace("send HTTP GET to: {} ", command.toCommandURL(baseUrl));
            }
