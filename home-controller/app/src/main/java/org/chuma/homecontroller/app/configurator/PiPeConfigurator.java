...
public class PiPeConfigurator extends AbstractConfigurator {
    ...
    public void configure() {
        ...
        LouversController zKuchyn = addLouversController("lvKuchyn", "Kuchyň", releBoard2.getRelay(9), releBoard2.getRelay(10), 60_000);
        LouversController zObyvak1 = addLouversController("lvObyvak1", "Obyvák1", releBoard2.getRelay(15), releBoard2.getRelay(16), 60_000);
        LouversController zObyvak2 = addLouversController("lvObyvak2", "Obyvák2", releBoard1.getRelay(2), releBoard1.getRelay(1), 60_000);
        LouversController zObyvak3 = addLouversController("lvObyvak3", "Obyvák3", releBoard2.getRelay(2), releBoard2.getRelay(1), 60_000);
        LouversController zObyvak4 = addLouversController("lvObyvak4", "Obyvák4", releBoard3.getRelay(13), releBoard3.getRelay(14), 60_000);
        LouversController zObyvak5 = addLouversController("lvObyvak5", "Obyvák5", releBoard3.getRelay(11), releBoard3.getRelay(12), 60_000);
        LouversController zObyvak6 = addLouversController("lvObyvak6", "Obyvák6", releBoard2.getRelay(6), releBoard2.getRelay(5), 60_000);
        LouversController zObyvak7 = addLouversController("lvObyvak7", "Obyvák7", releBoard2.getRelay(4), releBoard2.getRelay(3), 60_000);
        ...
        LouversController zMates2 = addLouversController("lvMates2", "Mates2", releBoard1.getRelay(5), releBoard1.getRelay(6), 32_000);
        LouversController zMates1 = addLouversController("lvMates1", "Mates1", releBoard1.getRelay(7), releBoard1.getRelay(8), 32_000);
