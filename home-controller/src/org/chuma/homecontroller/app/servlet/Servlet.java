...
import org.chuma.homecontroller.app.NodeInfo;
...
import org.chuma.homecontroller.nodes.node.Pic;
...
public class Servlet extends AbstractHandler {
    ...
    private void sendFile(String target, HttpServletResponse response, String contentType) throws IOException {
        if (!target.contains(":") && !target.contains("..")) {
            ...
            InputStream in = this.getClass().getResourceAsStream("/org/chuma/homecontroller/app/servlet/resources" + target);
            if (in != null) {
