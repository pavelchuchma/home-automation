...
//                    log.error("Constructor failed", e);
    ...
    private void playSound(boolean b) throws UnsupportedAudioFileException, IOException, LineUnavailableException, InterruptedException {
        log.info("Playing...");
        InputStream in = this.getClass().getResourceAsStream("/resources/WindowsLogonSound.wav");
        log.info("1");
